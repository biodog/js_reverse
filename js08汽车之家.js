...
function ErroInfo(msg) {
    if (msg != "") {
        ...
        // setTimeout(hideErroInfo, 3000);
    }
}

function hideErroInfo() {
    // $('#ToolTip').slideDown(2000);
    $('phonemsg').innerHTML = "";
    //$("phonemsg").style.display = "none";
}

function resetgeetecaptcha1() {
    tx_Ticket = "";
    tx_Randstr = "";
    //验证按钮显示控制
    document.getElementById("verify1").style.display = "block";
    document.getElementById("verify1_success").style.display = "none";
}

function resetgeetecaptcha2() {
    tx_Ticket2 = "";
    tx_Randstr2 = "";
    //验证按钮显示控制
    document.getElementById("verify2").style.display = "block";
    document.getElementById("verify2_success").style.display = "none";
}
