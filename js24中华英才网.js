...
//     var n = t
//         , r = $("#" + t.divid).find("input[name]");
//     var s = 1411093327735 - (new Date).getTime();
//     return n.timesign = (new Date).getTime() + s,
//         n.passwordEncrypted = encryptString(n.timesign + encodeURIComponent(n.passwordInput), n.rsaExponent, n.rsaModulus),
//         n.p = encryptString(n.timesign + encodeURIComponent(n.mobile), n.rsaExponent, n.rsaModulus),
//         n
// }

s = "1411093327735" + "123456"
e = "010001"
...
console.log(encryptString(s,e,m))